...
contract DataAttestation {
    ...
    uint256 constant INPUT_CALLS = 4;
    ...
    function verifyWithDataAttestation(address verifier, bytes memory encoded) public view returns (bool) {
        ...
        assembly {
            ...
            */
            ...
            for { let i := 0 } lt(i, sub(mload(encoded), 4)) { i := add(i, 0x20) } {
